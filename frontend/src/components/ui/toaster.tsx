...
/* ------------------------------------------------------------------
 * Toaster — renders the toast queue from the useToast hook
 * ------------------------------------------------------------------ */
...
// Simple global toast state — replace with a proper store in Phase 5 if needed
...
export function toast(props: Omit<ToastState, 'id'>) {
  ...
  toastQueue.push({ ...props, id, open: true });
  notifyListeners();
}
